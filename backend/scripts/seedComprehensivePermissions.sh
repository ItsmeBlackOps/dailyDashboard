#!/bin/bash
# Comprehensive Permissions Seed Data - 150+ permiss ions
# This script seeds the database with realistic role-permission mappings
...
if [ -z "$TOKEN" ]; then
  ...
  echo "Usage: ADMIN_TOKEN=your_token ./seedComprehensivePermissions.sh"
  exit 1
fi

echo "🌱 Seeding Comprehensive Permissions (150+)..."
...
SEED_DATA='{
  "rolePermissions": {
    ...
    "mm": [
      ...
      "candidates_create_new", "candidates_edit_any", "candidates_edit_name", "candidates_edit_recruiter", "candidates_filter_by_status", "candidates_filter_by_recruiter", "candidates_search", "candidates_start_tour",
    ...
    "mam": [
      ...
      "candidates_view_page", "candidates_view_list", "candidates_view_name_column", "candidates_view_expert_column", "candidates_view_status_column",
      "candidates_edit_expert", "candidates_filter_by_expert", "candidates_search",
    ...
    "mlead": [
      ...
      "candidates_view_page", "candidates_view_list", "candidates_view_name_column", "candidates_view_expert_column", "candidates_view_status_column",
      "candidates_edit_expert", "candidates_filter_by_expert",
    ...
    "recruiter": [
      ...
      "candidates_view_page", "candidates_view_list", "candidates_view_name_column", "candidates_view_email_column", "candidates_view_contact_column", "candidates_view_technology_column", "candidates_view_recruiter_column", "candidates_view_status_column", "candidates_view_actions_column",
      "candidates_edit_own", "candidates_edit_name", "candidates_edit_contact", "candidates_filter_by_status", "candidates_search", "candidates_start_tour",
...
if [ "$HTTP_CODE" = "200" ]; then
  echo "✅ Comprehensive Permissions seeded successfully!"
  echo "$BODY" | jq '.' 2>/dev/null || echo "$BODY"
  echo ""
  echo "📊 Permission Summary:"
  echo "   Total Permissions: 150+"
  echo "   Total Roles: 12"
  echo "   Categories: 14"
else
