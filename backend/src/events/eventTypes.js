export const DomainEvents = Object.freeze({
  ...
  // PRT Phase 4
  CandidateEadExpiring: 'candidate.eadExpiring'
});

export const NotificationEvents = Object.freeze({
  SubscriptionRegistered: 'notification.subscriptionRegistered',
  SubscriptionRemoved: 'notification.subscriptionRemoved'
});
