...
const BUCKET_CONFIG: Record<AgingStatus, { label: string; color: string; bg: string; border: string; badge: string }> = {
  fresh:    { label: 'Fresh',    color: 'text-green-600',  bg: 'bg-green-50',   border: 'border-green-200',  badge: 'bg-green-100 text-green-700 border-green-300' },
  warm:     { label: 'Warm',     color: 'text-yellow-600', bg: 'bg-yellow-50',  border: 'border-yellow-200', badge: 'bg-yellow-100 text-yellow-700 border-yellow-300' },
  aging:    { label: 'Aging',    color: 'text-orange-600', bg: 'bg-orange-50',  border: 'border-orange-200', badge: 'bg-orange-100 text-orange-700 border-orange-300' },
  critical: { label: 'Critical', color: 'text-red-600',    bg: 'bg-red-50',     border: 'border-red-200',    badge: 'bg-red-100 text-red-700 border-red-300' },
};
          ...
          {editorOpen && (
            <CardContent className="p-3 pt-0 space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {saveMsg && (
                  <span className={`text-xs ${saveMsg.includes('aved') ? 'text-green-600' : 'text-red-600'}`}>
                    {saveMsg}
                  </span>
                )}
              </div>
