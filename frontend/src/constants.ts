...
export const LOGIN_SCOPES = (import.meta.env.VITE_LOGIN_SCOPES || 'User.Read https://graph.microsoft.com/OnlineMeetings.ReadWrite https://graph.microsoft.com/Calendars.ReadWrite').split(/\s+/).filter(Boolean);
