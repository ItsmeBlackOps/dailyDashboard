...
export default function TasksToday() {
  ...
  const displayedTasks = tasks
    ...
    .sort((a, b) => {
      const aTime = moment(a["Start Time Of Interview"] || "", "HH:mm");
      const bTime = moment(b["Start Time Of Interview"] || "", "HH:mm");
      if (!aTime.isValid() || !bTime.isValid()) return 0;
      if (aTime.isBefore(bTime)) return sortAsc ? -1 : 1;
      if (aTime.isAfter(bTime)) return sortAsc ? 1 : -1;
      return 0;
    });
